...
public class CacheTest {
    ...
    public void testDecimal() throws Exception {
        StatEntry se = new StatEntry(1, "test_board", "testprefix", "testplayer", "testplayerdisplay", UUID.randomUUID(), "testsuffix", 1.5, TimedType.ALLTIME, 0L);
    ...
    public void testComma() throws Exception {
        StatEntry se = new StatEntry(1, "test_board", "testprefix", "testplayer", "testplayerdisplay", UUID.randomUUID(), "testsuffix", 1500, TimedType.ALLTIME, 0L);
    ...
    public void testCommaDecimal() throws Exception {
        StatEntry se = new StatEntry(1, "test_board", "testprefix", "testplayer", "testplayerdisplay", UUID.randomUUID(), "testsuffix", 1500.5, TimedType.ALLTIME, 0L);
