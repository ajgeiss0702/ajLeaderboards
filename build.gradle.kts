...
dependencies {
    ...
    implementation("us.ajg0702.commands.platforms.bukkit:bukkit:1.0.0-pre11")
    implementation("us.ajg0702.commands.api:api:1.0.0-pre11")
...
tasks.shadowJar {
    relocate("net.kyori", "us.ajg0702.leaderboards.kyori")
